...
public class Robot extends IterativeRobot {
	...
	public static Subsystem vision;
    ...
    public void teleopPeriodic() {
        ...
        SmartDashboard.putString("Distance - Left SHOOTER", Math.floor(RobotMap.shooterShooterLeftEncoder.getDistance() * 1000) / 1000 + "");
        SmartDashboard.putString("Distance - Right SHOOTER", Math.floor(RobotMap.shooterShooterRightEncoder.getDistance() * 1000) / 1000 + "");
