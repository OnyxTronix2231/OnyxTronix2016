...
import org.usfirst.frc2231.OnyxTronix2016.commands.ChevalDeFriseAutonomous;
import org.usfirst.frc2231.OnyxTronix2016.commands.GateAutonomous;
import org.usfirst.frc2231.OnyxTronix2016.commands.LowBarAutonomous;
import org.usfirst.frc2231.OnyxTronix2016.commands.MoatAutonomous;
import org.usfirst.frc2231.OnyxTronix2016.commands.ProcessImage;
import org.usfirst.frc2231.OnyxTronix2016.commands.RampartsAutonomous;
import org.usfirst.frc2231.OnyxTronix2016.commands.RockWallAutonomous;
import org.usfirst.frc2231.OnyxTronix2016.commands.RoughTerrainAutonomous;
...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        obstacles.addDefault("Low Bar", new LowBarAutonomous());
        obstacles.addObject("Gate", new GateAutonomous());
        obstacles.addObject("Cheval de Frise", new ChevalDeFriseAutonomous()); // The four "FlipFlops"
        obstacles.addObject("Moat", new MoatAutonomous()); // The "U" Channel
        obstacles.addObject("Ramparts", new RampartsAutonomous());
        obstacles.addObject("Rock Wall", new RockWallAutonomous());      
        obstacles.addObject("Rough Terrain", new RoughTerrainAutonomous());      
        
        positions = new SendableChooser(); 
        positions.addDefault("1", new Object());
        positions.addObject("2", new Object());
        positions.addObject("3", new Object());
        positions.addObject("4", new Object());
        positions.addObject("5", new Object());
