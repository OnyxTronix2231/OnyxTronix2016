...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        obstacles.addDefault("Low Bar", new Autonomous_LowBar());
        obstacles.addObject("Gate", new Autonomous_Gate());
        obstacles.addObject("Cheval de Frise", new Autonomous_ChevalDeFrise()); // The four "FlipFlops"
        obstacles.addObject("Moat", new Autonomous_Moat()); // The "U" Channel
        obstacles.addObject("Ramparts", new Autonomous_Ramparts());
        obstacles.addObject("Rock Wall", new Autonomous_Rockwall());      
        obstacles.addObject("Rough Terrain", new Autonomous_RoughTerrain());      
