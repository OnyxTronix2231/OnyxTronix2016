...
//		}
    ...
    public void operatorControl() {
    	debugText("inside operator control\tisOperatorControl: " + isOperatorControl() + "\tisEnabled(): " + isEnabled() + "\n");
...
//    	teleopPeriodic();
    	while (isOperatorControl() && isEnabled()) {
    			debugText("inside while loop\n");
    			Timer.delay(0.005);
    	}
    		//vision.ImageProcessing();				
    		//vision.calculateDistance();
    		//distanceFromTarget = vision.getDistance();
    		//System.out.println(distanceFromTarget);
    		//vision.activateDashboard();
