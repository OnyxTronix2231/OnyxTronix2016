...
public class RobotMap {
    ...
    public static SpeedController collectorCollectorSpiner;
    ...
    public static Solenoid reloaderopenSolenoid;
    public static Solenoid reloadercloseSolenoid;
    ...
    public static void init() {
        ...
        collectorCollectorSpiner = new Talon(4);
        LiveWindow.addActuator("Collector", "CollectorSpiner", (Talon) collectorCollectorSpiner);
        ...
        reloaderopenSolenoid = new Solenoid(0, 0);
        LiveWindow.addActuator("Reloader", "openSolenoid", reloaderopenSolenoid);
        
        reloadercloseSolenoid = new Solenoid(0, 1);
        LiveWindow.addActuator("Reloader", "closeSolenoid", reloadercloseSolenoid);
