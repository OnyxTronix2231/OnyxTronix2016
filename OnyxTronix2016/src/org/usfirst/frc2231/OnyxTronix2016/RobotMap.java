...
public class RobotMap {
    ...
    public static void init() {
        ...
        collectorCollectorSpinner = new CANTalon(2);
        ...
        driveTrainLeftCopy = new CANTalon(18);
        LiveWindow.addActuator("DriveTrain", "LeftCopy", (CANTalon) driveTrainLeftCopy);
        ...
        driveTrainRightCopy = new CANTalon(19);
        LiveWindow.addActuator("DriveTrain", "RightCopy", (CANTalon) driveTrainRightCopy);
        ...
        shooterShooterLeftMotor = new CANTalon(3);
        ...
        reloaderReloaderWheel = new CANTalon(5);
