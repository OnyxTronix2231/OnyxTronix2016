...
public class RobotMap {
    ...
    public static void init() {
        ...
        LiveWindow.addActuator("MyCollector", "CollectorSpinner", (Talon) collectorCollectorSpinner);
        
        collectorleftOpenSolenoid = new Solenoid(0, 4);
        LiveWindow.addActuator("MyCollector", "leftOpenSolenoid", collectorleftOpenSolenoid);
        
        collectorrightOpenSolenoid = new Solenoid(0, 5);
        LiveWindow.addActuator("MyCollector", "rightOpenSolenoid", collectorrightOpenSolenoid);
        
        
        collectorrightCloseSolenoid = new Solenoid(0, 2);
        LiveWindow.addActuator("MyCollector", "rightCloseSolenoid", collectorrightCloseSolenoid);
        
        collectorleftCloseSolenoid = new Solenoid(0, 1);
        LiveWindow.addActuator("MyCollector", "leftCloseSolenoid", collectorleftCloseSolenoid);
        
        collectorCompressor = new Compressor(0);
        
        
        driveTrainCloseShifter = new Solenoid(0, 3);
        LiveWindow.addActuator("MyDriveTrain", "CloseShifter", driveTrainCloseShifter);
        
        driveTrainOpenShifter = new Solenoid(0, 6);
        LiveWindow.addActuator("MyDriveTrain", "OpenShifter", driveTrainOpenShifter);
        
        driveTrainUltrasonic1 = new Ultrasonic(9, 10);
        ...
        LiveWindow.addActuator("MyDriveTrain", "Right", (TalonSRX) driveTrainRight);
        
        driveTrainLeft = new TalonSRX(0);
        LiveWindow.addActuator("MyDriveTrain", "Left", (TalonSRX) driveTrainLeft);
        ...
        LiveWindow.addActuator("MyShooter", "ShooterRightMotor", (Talon) shooterShooterRightMotor);
        
        shooterRightPIDController = new PIDController(1.0, 0.0, 0.0, 0.0, shooterShooterRightEncoder, shooterShooterRightMotor, 0.02);
        LiveWindow.addActuator("MyShooter", "RightPIDController", shooterRightPIDController);
        ...
        LiveWindow.addActuator("MyShooter", "ShooterLeftMotor", (Talon) shooterShooterLeftMotor);
        
        shooterShooterLeftEncoder = new Encoder(4, 5, false, EncodingType.k4X);
        ...
        LiveWindow.addActuator("MyShooter", "LeftPIDController", shooterLeftPIDController);
        ...
        LiveWindow.addActuator("MyClimber", "Speed Controller 1", (Talon) climberSpeedController1);
        
        climberSpeedController2 = new Talon(6);
        LiveWindow.addActuator("MyClimber", "Speed Controller 2", (Talon) climberSpeedController2);
        
        reloaderReloaderWheel = new Talon(2);
        LiveWindow.addActuator("MyReloader", "ReloaderWheel", (Talon) reloaderReloaderWheel);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        driveTrainLeftPIDController = new PIDController(0.07, 0, 0.03, 0, driveTrainLeftEncoder, driveTrainLeft, 0.02);
        LiveWindow.addActuator("MyDriveTrain", "leftPidController", driveTrainLeftPIDController);
        ...
        driveTrainRightPIDController = new PIDController(0.07, 0, 0.03, 0, driveTrainLeftEncoder, driveTrainRight, 0.02);
        LiveWindow.addActuator("MyDriveTrain", "RightPidController", driveTrainRightPIDController);
