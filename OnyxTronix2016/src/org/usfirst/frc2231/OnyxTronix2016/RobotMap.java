...
public class RobotMap {
    ...
    public static void init() {
        ...
        collectorleftOpenSolenoid = new Solenoid(0, 0);
        ...
        driveTrainCloseShifter = new Solenoid(0, 2);
        LiveWindow.addActuator("DriveTrain", "CloseShifter", driveTrainCloseShifter);
        
        driveTrainOpenShifter = new Solenoid(0, 3);
        ...
        reloaderReloaderWheel = new Talon(5);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        driveTrainRightPIDController = new PIDController(0.07, 0, 0.03, 0, driveTrainRightEncoder, driveTrainRight, 0.02);
