...
public class RobotMap {
    ...
    public static void init() {
        ...
        collectorrightCloseSolenoid = new Solenoid(0, 3);
        LiveWindow.addActuator("Collector", "rightCloseSolenoid", collectorrightCloseSolenoid);
        
        collectorrightOpenSolenoid = new Solenoid(0, 2);
        ...
        shooterShooterIndexedEncoder = new Encoder(8, 7, false);
        ...
        reloaderisCollected = new DigitalInput(9);
