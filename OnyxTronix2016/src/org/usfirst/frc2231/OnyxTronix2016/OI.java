...
//        emergencyStart.whenPressed(new StartEmergency());
        ...
        shootByVision.whenPressed(new ShootByTimeout());
        autoShoot = new JoystickButton(buttonStick, 10);
        autoShoot.whenPressed(new ShootByEncoders());
        autoCollect = new JoystickButton(buttonStick, 1);
