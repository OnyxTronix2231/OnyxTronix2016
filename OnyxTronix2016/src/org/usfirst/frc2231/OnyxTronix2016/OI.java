...
import org.usfirst.frc2231.OnyxTronix2016.commands.ShootByEncoders;
...
public class OI {
	...
	public JoystickButton shootByEncoders;
	private JoystickButton collectorClose1;
	private JoystickButton collectorOpen1;
    ...
    public OI() {
        ...
        SmartDashboard.putData("ShootByEncoders", new ShootByEncoders());

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        shootByEncoders = new JoystickButton(buttonStick, 9);
        shootByEncoders.whenPressed(new ShootByEncoders());
        collectorClose1 = new JoystickButton(driveStick, 2);
        collectorClose1.whileHeld(new CloseCollector());
        collectorOpen1 = new JoystickButton(driveStick, 3);
        collectorOpen1.whileHeld(new OpenCollector());
