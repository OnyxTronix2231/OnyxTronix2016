...
public class VisionCommands implements Runnable{
...
//    	double areaRatio = 0; // The ratio between the the particle area and the area of the bounding recticle of the area
    	...
    	private final double ANGLE_TO_FLOOR = 35; // The angle between the y axis of the robot and the camera
    	...
    	public void run(){
    		...
    		while(isProcessing){
    			...
    			try {
    				System.out.println(calculateDistance(particleReport));
...
//    			try {
//    				System.out.println(calculateAreaRatio(par));
//    			} catch (NIVisionException e) {
//    				// TODO Auto-generated catch block
//    				e.printStackTrace();
//    			}
		...
		public double calculateDistance(newParticleAnalysisReport par) throws NIVisionException {
			...
			/*Below the middle of the picture*/
				...
				targetAngle = ANGLE_TO_FLOOR - VERTICLE_APERTURE_ANGLE/2 + VERTICLE_APERTURE_ANGLE/2 * (par.imageHeight-par.center_mass_y) / (par.imageHeight/2);
			}
