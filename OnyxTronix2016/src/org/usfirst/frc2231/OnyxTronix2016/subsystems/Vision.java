 ...
 *
 */
public class Vision extends Subsystem implements PIDSource, Runnable {
    ...
    private double hypotenuse = 0; // "YETER"
    private double distance = 0; // The distance between the robot and the target
