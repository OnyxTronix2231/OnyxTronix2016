...
public class DriveTrain extends PIDSubsystem {
    ...
    private final double WHEEL_RADIUS = 4.25;
    private final double IN = 2.48;
    public final double PERIMETER = WHEEL_RADIUS * IN * 2 * Math.PI;
    ...
    {    	
    	robotDrive21.arcadeDrive(-Robot.oi.driveStick.getRawAxis(1), Robot.oi.driveStick.getRawAxis(4));
    }
    double forward = -0.5;
    double side = 0.5;
