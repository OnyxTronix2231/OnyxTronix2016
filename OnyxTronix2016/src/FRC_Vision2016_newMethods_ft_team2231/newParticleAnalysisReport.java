 ...
 * @author dtjones
 */
public class newParticleAnalysisReport {
  ...
  newParticleAnalysisReport(newBinaryImage image, int index) throws NIVisionException {
  ...
  static double getParticleToImagePercent(newBinaryImage image, int index) throws NIVisionException {
